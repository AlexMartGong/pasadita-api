...
public class SaleCreateDto {
    ...
    @DecimalMin(value = "0.0", message = "The subtotal must be a non-negative value")
    ...
    @DecimalMin(value = "0.0", message = "The discount amount must be a non-negative value")
    ...
    @DecimalMin(value = "0.0", message = "The total must be a non-negative value")
